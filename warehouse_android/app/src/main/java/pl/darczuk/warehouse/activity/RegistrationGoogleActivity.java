...
public class RegistrationGoogleActivity extends AppCompatActivity implements View.OnClickListener {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        mRadioGroupView = findViewById(R.id.radioGroupGoogle);
    ...
    public void onActivityResult(int requestCode, int resultCode, Intent data) {
        ...
        if (requestCode == RC_SIGN_IN) {
            ...
            try {
                ...
                mRadioButtonView = findViewById(selectedId);
                String role = mRadioButtonView.getText().toString();

//                HttpClient.postGoogleRegistration(idToken, role);
                try {
                    GoogleRegistrationTask mAuthTask = new GoogleRegistrationTask();
                    String response = mAuthTask.execute(idToken, role).get();
    ...
    private void updateUI(FirebaseUser user) {
        ...
        if (user != null) {
           ...
           // findViewById(R.id.signOutAndDisconnect).setVisibility(View.VISIBLE);
            ...
            //signOutAndDisconnectfindViewById(R.id.signOutAndDisconnect).setVisibility(View.GONE);
        }
    }
...
//            revokeAccess();
    ...
    public class GoogleRegistrationTask extends AsyncTask<String, Void, String> {
